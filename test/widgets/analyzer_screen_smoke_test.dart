...
void main() {
  testWidgets('AnalyzerScreen renders spectrum, spectrogram and mic toggle without starting the mic', (tester) async {
    ...
    expect(find.text('Appuie sur le micro pour démarrer l\'analyse en direct.'), findsOneWidget);
  });
}
