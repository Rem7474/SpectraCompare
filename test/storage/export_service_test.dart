...
Measurement _measurement(String model, List<FrequencyResponsePoint> points) =>
    Measurement(
...
void main() {
  group('ExportService', () {
    ...
    test(
      'comparisonToCsv aligns measurements by frequency and leaves gaps blank',
      () {
    ...
    test('measurementToJson round-trips key fields', () {
      ...
      final json =
          jsonDecode(ExportService.measurementToJson(m))
    ...
    test('measurementsToJson produces a JSON array', () {
      ...
      final json =
          jsonDecode(ExportService.measurementsToJson(list)) as List<dynamic>;
